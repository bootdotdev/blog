...
Before I begin, I must give thanks to Nick for having me on the show! In this episode of Running in Production, I talk with Nick about how we built [Qvault](https://qvault.io/), an open-source password manager that specializes in cryptocurrency. Qvault uses Electron and has a Serverless component that uses Golang. It’s all hosted on AWS.
