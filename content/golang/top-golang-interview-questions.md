...
1. [What's the difference between a goroutine and an operating system thread?](#goroutine-thread)
2. [Can constants be computed in Go?](#computed-constants)
3. [What does the Go ecosystem use for package and dependency management?](#package-dep)
4. [How would you succinctly swap the values of two variables in Go?](#swap)
5. [Do you have any preferences for error handling methodologies in Go?](#error-handling)
6. [What is a pointer and when would you use it?](#pointer)
7. [Describe the difference between sync.Mutex and sync.RWMutex?](#mutexes)
8. [Consider the following code. What will be the value of s1?](#code-practice)
9. [Are channels and maps safe for concurrent access?](#concurrent-access)
10. [How would you sort a slice of custom structs?](#sort-structs)
11. [Does Go support generic programming?](#generics)
12. [Is `ni`l only valid on pointer types?](#nil-pointer)
13. [Does Go provide support for OOP via classes?](#oop-classes)
14. [How do you export functions from a package?](#export-func)
15. [What do you like about Go?](#like-go)
