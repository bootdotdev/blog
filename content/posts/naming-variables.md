...
1. [Following existing naming conventions of the language or framework that you're using](#conventions)
2. [Single letter variables have a place, and that place is rare](#single-letter)
3. [Include units in your variable names](#units)
4. [Include types in your variables names if it isn't obvious](#types)
5. [Make the name as long as necessary but no longer](https://qvault.io/wp-admin/post.php?post=189170&action=edit#long-names)
6. [Include the meaning of complex calculations in your variable names](#calculations)
7. [Use the properly pluralized form of the item](#pluralized)
8. [Don't use abbreviations or acronyms without sufficient context](#abbreviation)
9. [No magic numbers or magic values, use a variable](#magic-number)
