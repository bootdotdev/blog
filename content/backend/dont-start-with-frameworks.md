...
Frameworks are *great* at automating all that boring stuff, like boilerplate code, authentication, and [database migrations](https://blog.boot.dev/clean-code/death-taxes-and-database-migrations/). Who wants to do the same thing over and over again?
...
That certainly *can* be the case in smaller applications, but as a company grows, the back-end tends to become larger and more complex. Frankly, the servers that serve up the front-end might end up being some of the simplest parts of the stack.
